    ...
    <div class="container mt-2">
        ...
        <div class="row">
            <div class="col col-md-6">
                <img src="/template/images/marketing.png">
            </div>
            <div class="col col-md-6">
                <form class="w-full" action="{{'contact_new'}}" method="post">
                    @csrf
                    ...
                    <button type="submit" class="btn btn-primary" name="btnGoiLoiNhan">Gởi lời nhắn</button>
                </form>
            </div>
        </div>
        <div class="row mt-2">
