...
@section('content')
    <div class="container p-t-80">
        <div class="bread-crumb flex-w p-l-25 p-r-15 p-t-30 p-lr-0-lg">
            ...
            <a href="/danh-muc/{{ $sale->menu->id }}-{{ Str::slug($sale->menu->name) }}.html"
                                    ...
                                    <div class="slick-track" style="opacity: 1; width: 1539px;">
                                        <div class="item-slick3 slick-slide slick-current slick-active"
                                            ...
                                            <div class="wrap-pic-w pos-relative">
                                                <img src="{{ $sale->thumb }}" alt="IMG-PRODUCT">
                                    ...
                                    <div class="p-b-30 m-lr-15-sm">
                                        ...
                                        <form>
                                            ...
                                            <div class="flex-w flex-t p-b-68">
                                                <input type="hidden" name="product_id" class="product_id" value="{{$sale->id}}">
                                            ...
                                            <div class="row p-b-25">
                                                <form action="{{url('comments')}}" method="POST">
                                                    <div class="col-12 p-b-5">
                                                        ...
                                                        <input type="hidden" name="post_slug" value="">
