                ...
                <div class="col-md-6 col-lg-5 p-b-30">
                    <div class="p-r-50 p-t-5 p-lr-0-lg">
                        ...
                        <span class="mtext-106 cl2">
							{!! \App\Helpers\Helper::price($product->price, $product->price) !!}
						</span>
...
{{--                        </li>--}}
                        ...
                        <li class="nav-item p-b-10">
                            <a class="nav-link" data-toggle="tab" href="#reviews" role="tab">{{ $product->comments()->count() }} Comments</a>
                        </li>
                    </ul>
                                    ...
                                    <div class="p-b-30 m-lr-15-sm">
                                        ...
                                        <div class="flex-w flex-t p-b-68">
                                            <div class="wrap-pic-s size-109 bor0 of-hidden m-r-18 m-t-6">
                                                <img src="/template/images/comment.png" alt="AVATAR">
                                            </div>
...
{{--													</span>--}}
                                        ...
                                        <!-- Add review -->
                                        <form class="w-full" action="{{ route('sanpham_comment', $product->id) }}" method="post">
                                            @csrf
...
{{--                                            </div>--}}
                                            ...
                                            <div class="row p-b-25">
                                                <div class="col-12 p-b-5">
                                                    <label class="stext-102 cl3" for="comment_body">Nội Dung</label>
                                                    @csrf
